...
class FrequencyStack {
    ...
    class ElementComparator implements java.util.Comparator<com.mycompany.stack.FrequencyStack.Element> {
    ...
    java.util.PriorityQueue<com.mycompany.stack.FrequencyStack.Element> maxHeap = new java.util.PriorityQueue<com.mycompany.stack.FrequencyStack.Element>(new ElementComparator());
